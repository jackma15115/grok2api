  ...
  "zh-CN": {
    translation: {
      ...
      accountConversion: {
        ...
        jitter: "随机抖动上限（ms）",
        retries: "失败重试次数",
        status: { queued: "已排队", running: "后台执行中", canceling: "正在终止", completed: "已完成", failed: "失败", canceled: "已终止" },
        cancel: "终止任务",
        canceled: "任务已终止",
        start: "开始转换",
      },
      ...
      apiErrors: {
        ...
        accountImportLimitExceeded: "账号凭据超过 15000 个，无法单次导入",
        ...
        accountConversionBusy: "已有 Grok Web 到 Build 转换任务正在后台运行",
  ...
  en: {
    translation: {
      ...
      accountConversion: {
        ...
        all: "Reconvert all",
        concurrency: "Conversion concurrency",
        jitter: "Jitter maximum (ms)",
        retries: "Retries per account",
        status: { queued: "Queued", running: "Running in background", canceling: "Stopping", completed: "Completed", failed: "Failed", canceled: "Stopped" },
        cancel: "Stop task",
      ...
      apiErrors: {
        ...
        accountImportLimitExceeded: "More than 15,000 accounts cannot be imported at once",
        ...
        accountConversionBusy: "A Grok Web to Build conversion task is already running in the background",
